...
const BlogPage = () => {
    ...
    useEffect(() => {
        if (title) {
            ...
            setMeta('property', 'og:description', des);
            setMeta('property', 'og:image', banner);
            setMeta('property', 'og:url', blogUrl);
            setMeta('property', 'og:type', 'article');
            setMeta('name', 'twitter:title', title);
            setMeta('name', 'twitter:description', des);
            setMeta('name', 'twitter:image', banner);
            setMeta('name', 'twitter:card', 'summary_large_image');
        }

        return () => {
            document.title = 'AllInfo - Your Source for Quality Content';
        };
    }, [title, banner, blog.des, blog_id])
