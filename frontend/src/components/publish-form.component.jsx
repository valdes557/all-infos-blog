...
const PublishForm = () => {
    ...
    let { blog, blog: { banner, title, tags, des, content, category }, setEditorState, setBlog } = useContext(EditorContext);
    ...
    const publishBlog = (e) => {
        ...
        let blogObj = {
            title, banner, des, content, tags, category: category || "", draft: false
        }
        ...
        <AnimationWrapper>
            <section className="w-screen min-h-screen grid items-center lg:grid-cols-2 py-16 lg:gap-4">
                ...
                <div className="border-grey lg:border-1 lg:pl-8">
                    ...
                    <button className="btn-dark px-8 mt-8"
                        onClick={publishBlog}
                    >Publish</button>
